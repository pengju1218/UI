package com.example.csdn.view.ImageView;
...
public class RoundColorImageView extends ImageView {
	...
	public RoundColorImageView(Context context) {
		super(context);
		mContext = context;
	}

	public RoundColorImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		setAttributeset(attrs);
	}

	public RoundColorImageView(Context context, AttributeSet attrs, int defStyle) {
