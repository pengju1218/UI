...
public class MultipleTextView extends RelativeLayout {
	...
	public MultipleTextView(Context context, AttributeSet attrs) {
		...
		TypedArray array = context.obtainStyledAttributes(attrs,
				R.styleable.mutilStyle);
		textColor = array.getColor(R.styleable.mutilStyle_mytextColor, 0XFF00FF00); // 提供默认值，放置未指定
		textSize = array.getDimension(R.styleable.mutilStyle_mytextSize, 24);
		textSize=px2sp(context,textSize);
		wordMargin = array.getDimensionPixelSize(R.styleable.mutilStyle_textWordMargin, 0);
		lineMargin = array.getDimensionPixelSize(R.styleable.mutilStyle_textLineMargin, 0);
		textBackground = array.getDrawable(R.styleable.mutilStyle_textBackground);
		textPaddingLeft = array.getDimensionPixelSize(R.styleable.mutilStyle_textPaddingLeft, 0);
		textPaddingRight = array.getDimensionPixelSize(R.styleable.mutilStyle_textPaddingRight, 0);
		textPaddingTop = array.getDimensionPixelSize(R.styleable.mutilStyle_textPaddingTop, 0);
		textPaddingBottom = array.getDimensionPixelSize(R.styleable.mutilStyle_textPaddingBottom, 0);
		array.recycle();
		//下边是获取系统属性
