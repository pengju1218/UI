...
public class MoreTextView extends LinearLayout{
	...
	protected void initWithAttrs(Context context, AttributeSet attrs) {
		...
		int textColor = a.getColor(R.styleable.MoreTextStyle_more_textColor,  
				defaultTextColor);  
		textSize = a.getDimensionPixelSize(R.styleable.MoreTextStyle_more_textSize, defaultTextSize);
		maxLine = a.getInt(R.styleable.MoreTextStyle_maxLine, defaultLine);
		text = a.getString(R.styleable.MoreTextStyle_more_text);
